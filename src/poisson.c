...
SEXP cleanup(double *s, double *w, double *a, double *r, int *e, double *z, double *eta, SEXP beta0, SEXP beta, SEXP Dev, SEXP iter) {
  Free(s);
  Free(w);
  Free(a);
  Free(r);
...
SEXP cdfit_poisson(SEXP X_, SEXP y_, SEXP penalty_, SEXP lambda, SEXP eps_, SEXP max_iter_, SEXP gamma_, SEXP multiplier, SEXP alpha_, SEXP dfmax_, SEXP user_, SEXP warn_) {
  ...
  for (int l=lstart; l<L; l++) {
	...
	res = cleanup(s, w, a, r, e, z, eta, beta0, beta, Dev, iter);
	return(res);
      }
