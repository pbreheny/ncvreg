...
#'
#' Data from a subset of the Coronary Risk-Factor Study baseline survey, carried out in rural South
#' Africa.
#'
...
#'   \item{X}{
#'     A matrix with 462 observations (rows) and 9 predictor variables (columns). The remainder of
#'     this list describes the columns of `X`
#'   }
...
#'
#' Data from a randomised trial of two treatment regimens for lung cancer. This is a standard
#' survival analysis data set from the classic textbook by Kalbfleisch and Prentice.
#'
#' @format A list of two objects: `y` and `X`
#'
#' \describe{
#'   \item{y}{
#'     A two column matrix (`Surv` object) containing the follow-up time (in days) and an indicator
#'     variable for whether the patient died while on the study or not.
#'   }
#'   \item{X}{
#'     A matrix with 137 observations (rows) and 9 predictor variables (columns). The remainder of
#'     this list describes the columns of `X`
#'   }
...
#'   \item{squamous}{Indicator for whether the cancer type is squamous cell carcinoma (0=no, 1=yes)}
#'   \item{small}{Indicator for whether the cancer type is small cell lung cancer (0=no, 1=yes)}
#'   \item{adeno}{Indicator for whether the cancer type is adenocarcinoma (0=no, 1=yes)}
...
#'
#' Data from a study by by Stamey et al. (1989) to examine the association between prostate specific
#' antigen (PSA) and several clinical measures that are potentially associated with PSA in men who
...
#'   \item{y}{Log PSA}
#'   \item{X}{
#'     A matrix with 97 instances (rows) and 8 predictor variables (columns). The remainder of this
#'     list describes the columns of `X`
#'   }
