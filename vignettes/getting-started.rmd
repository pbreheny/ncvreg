...
This vignette offers a brief introduction to the basic use of `ncvreg`.  For more details on the package, visit the `ncvreg` website at <http://pbreheny.github.io/ncvreg> and follow the links under "Learn more".  For more on the algorithms used by `ncvreg`, see the original article:
